...
### 连续子数组最大和、最大积
??? note "[「Leetcode 53. 最大子序和」](https://leetcode-cn.com/problems/maximum-subarray/)"
...
??? note "[「Leetcode 1186. 删除一次得到子数组最大和」]()"
